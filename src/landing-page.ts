...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "env": { "USERNAME": "YOUR_VALUE_HERE", "PASSWORD": "YOUR_VALUE_HERE" },
  };
  const codexConfig = `[mcp_servers.CloudinaryMediaGeneration]
url = "${o}/sse"
http_headers = { "username" = "YOUR_USERNAME", "password" = "YOUR_PASSWORD" }`;
...
<head>
    ...
    <title>@cloudinary/media-generation-mcp MCP</title>
    <meta name="description" content="Install @cloudinary/media-generation-mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@cloudinary/media-generation-mcp - MCP Server">
    <meta property="og:description" content="Install @cloudinary/media-generation-mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@cloudinary/media-generation-mcp - MCP Server">
    <meta property="twitter:description" content="Install @cloudinary/media-generation-mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@cloudinary/media-generation-mcp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=CloudinaryMediaGeneration&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAY2xvdWRpbmFyeS9tZWRpYS1nZW5lcmF0aW9uLW1jcCIsInN0YXJ0IiwiLS11c2VybmFtZSIsIiIsIi0tcGFzc3dvcmQiLCIiXX0=">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=CloudinaryMediaGeneration&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAY2xvdWRpbmFyeS9tZWRpYS1nZW5lcmF0aW9uLW1jcCIsInN0YXJ0IiwiLS11c2VybmFtZSIsIiIsIi0tcGFzc3dvcmQiLCIiXX0=">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=CloudinaryMediaGeneration&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAY2xvdWRpbmFyeS9tZWRpYS1nZW5lcmF0aW9uLW1jcCIsInN0YXJ0IiwiLS11c2VybmFtZSIsIiIsIi0tcGFzc3dvcmQiLCIiXX0=">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=CloudinaryMediaGeneration&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAY2xvdWRpbmFyeS9tZWRpYS1nZW5lcmF0aW9uLW1jcCIsInN0YXJ0IiwiLS11c2VybmFtZSIsIiIsIi0tcGFzc3dvcmQiLCIiXX0=">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add CloudinaryMediaGeneration -- npx -y @cloudinary/media-generation-mcp start --username  --password </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add CloudinaryMediaGeneration -- npx -y @cloudinary/media-generation-mcp start --username  --password </code>
        </div>
      </div>
    </div>
